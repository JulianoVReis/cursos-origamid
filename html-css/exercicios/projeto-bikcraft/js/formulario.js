...
function formularioEnviado(resposta) {
	if (resposta.ok) {
		...
		formulario.innerHTML = '<p class="font-2-l" style="grid-column: 1/-1; padding: 1rem; border-radius: 4px; background: #f7f7f7"><span style="color: #e00000;">Erro no envio</span>, você pode enviar diretamente para o nosso email em: contato@email.com</p>'
	}
}
